...
| --- | --- | --- |
| Inter-contract call working | Complete | README section "Verified On-Chain Transactions" with tx `4a8587782f9942bd4cfde12759283b1872463368abb703e5caf92891d65b060c` showing settlement `record_payment` + pool `withdraw` |
| Custom token or pool deployed | Complete | Pool contract ID `CCLMRHFBY6NUYEOQKELODTZQXAUUQ7DKEC4YDACGR7BCGS4WENCNZPVG` in README "Deployed Contracts (Phase 8 Proof)" |
